...
public class AWSServiceImpl implements AWSService {
    ...
    public AWSServiceImpl(AmazonS3 amazonS3, AmazonElasticTranscoder elasticTranscoder, AmazonCloudFront cloudFront) {
    ...
    public void deleteFile(String fileKey) {
        amazonS3.deleteObject(new DeleteObjectRequest(s3Bucket, fileKey));
    }
